...
#     with logfire.span("Startd pdf parsing, (local)", filename=file_path):
#         try:
#             reader=PdfReader(file_path)
#             total_pages=len(reader)
#             logfire.info(f"The total pages are {total_pages}")
...
#             if blank_pages:
#                 logfire.info("Trying pdfplumber on the empty page returned by pypdf")
...
#                             fall_back_text=page.extract_text() or ""
#                             if fall_back_text.strip():
#                                 text_parts.append(fall_back_text)
                                
#                 except Exception as e:
#                     logfire.info(f"pdfpflumber failed {e}")
